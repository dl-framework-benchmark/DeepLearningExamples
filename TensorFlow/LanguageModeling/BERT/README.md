...
bash scripts/run_pretraining.sh 3 4 5e-5 fp16_xla 4 5000 2285000 5000 false
bash scripts/run_pretraining.sh 2 2 5e-5 fp16 1 5000 2285000 5000 false large multi
```
